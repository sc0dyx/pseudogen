...
```
Или другую версию (которую вам надо). Обратите внимание, что вы не сможете поставить версию ниже 0.2.2, т.к. они утеряны и автор их не тегал. Но вам они и не нужны, т.к. версии ниже 0.2.2 багованные (рабочие на коленках) и в реальных задачах бесполезны
```bash
